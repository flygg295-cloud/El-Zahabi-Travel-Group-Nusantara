      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Selamat datang di El-Zahabi Travel</p>
          </div>
          ...
          <button
            ...
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-gray-900 font-semibold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 mb-6"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
